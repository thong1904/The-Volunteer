...
public class SoundManager : MonoBehaviour
{
    ...
    public void PlayNewRank() => PlaySFX(newRankSound);
    public void PlayDrag() => PlaySFX(dragSound);
    public void PlayPut() => PlaySFX(putSound);
    public void PlayMale() => PlaySFX(maleSound);
    public void PlayFemale() => PlaySFX(femaleSound);
    public void PlayYeah() => PlaySFX(yeahSound);
    public void PlayNope() => PlaySFX(nopeSound);
    public void PlayDing() => PlaySFX(dingSound);
